      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-start gap-4">
            <Label htmlFor="specificConcern" className="text-right font-medium pt-2">
              Specific Concern
            </Label>
          ...
          {/* Row 6 */}
          <div className="grid grid-cols-4 items-start gap-4">
            <Label htmlFor="concernDetails" className="text-right font-medium pt-2">
              Concern Details
            </Label>
            <div className="col-span-3">
              <Textarea
                ...
                <Select value={selectedAssignee} onValueChange={setSelectedAssignee}>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="pedro-cruz">Pedro Cruz</SelectItem>
                    </SelectGroup>
                  </SelectContent>
                </Select>
              ) : (
        ...
        <DialogFooter className="gap-2">
          ...
          <Button
            ...
            type="button"
            onClick={handleSave}
            disabled={!selectedAssignee && !inquiry.assignedTo}
          >
            Save & Close
          </Button>
        </DialogFooter>
